/**
 * Freelance Lawyers Training — API client
 * ---------------------------------------------------------------------
 ...
 * a freelance-lawyers portal uses: sign-in, courses, progress, materials, the
...
(function () {
  ...
  var BASE = (typeof window !== 'undefined' && (window.FL_API_BASE || window.LAD_API_BASE)) || '';
  ...
  async function call(method, path, body) {
    if (!BASE) throw new Error('FL_API_BASE is not configured');
